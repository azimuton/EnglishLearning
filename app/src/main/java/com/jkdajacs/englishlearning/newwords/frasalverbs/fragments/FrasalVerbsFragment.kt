 ...
 * Use the [FrasalVerbsFragment.newInstance] factory method to
...
class FrasalVerbsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_frasal_verbs, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        ivF113.setOnClickListener {
            val english : String = tvE113.text.toString()
            val translate : String = tvT113.text.toString()
            val word = Word(englishWord = english, translateWord = translate)
            wordDatabase.wordDao().insertWord(word)
            Toast.makeText(context, "Запись скопирована!", Toast.LENGTH_SHORT).show()
        }
        ivF114.setOnClickListener {
            val english : String = tvE114.text.toString()
            val translate : String = tvT114.text.toString()
            val word = Word(englishWord = english, translateWord = translate)
            wordDatabase.wordDao().insertWord(word)
            Toast.makeText(context, "Запись скопирована!", Toast.LENGTH_SHORT).show()
        }
        ivF115.setOnClickListener {
            val english : String = tvE115.text.toString()
            val translate : String = tvT115.text.toString()
            val word = Word(englishWord = english, translateWord = translate)
            wordDatabase.wordDao().insertWord(word)
            Toast.makeText(context, "Запись скопирована!", Toast.LENGTH_SHORT).show()
        }
        ivF116.setOnClickListener {
            val english : String = tvE116.text.toString()
            val translate : String = tvT116.text.toString()
            val word = Word(englishWord = english, translateWord = translate)
            wordDatabase.wordDao().insertWord(word)
            Toast.makeText(context, "Запись скопирована!", Toast.LENGTH_SHORT).show()
        }
        ivF117.setOnClickListener {
            val english : String = tvE117.text.toString()
            val translate : String = tvT117.text.toString()
            val word = Word(englishWord = english, translateWord = translate)
            wordDatabase.wordDao().insertWord(word)
            Toast.makeText(context, "Запись скопирована!", Toast.LENGTH_SHORT).show()
        }
        ivF118.setOnClickListener {
            val english : String = tvE118.text.toString()
            val translate : String = tvT118.text.toString()
            val word = Word(englishWord = english, translateWord = translate)
            wordDatabase.wordDao().insertWord(word)
            Toast.makeText(context, "Запись скопирована!", Toast.LENGTH_SHORT).show()
        }
        ivF119.setOnClickListener {
            val english : String = tvE119.text.toString()
            val translate : String = tvT119.text.toString()
            val word = Word(englishWord = english, translateWord = translate)
            wordDatabase.wordDao().insertWord(word)
            Toast.makeText(context, "Запись скопирована!", Toast.LENGTH_SHORT).show()
        }
        ivF120.setOnClickListener {
            val english : String = tvE120.text.toString()
            val translate : String = tvT120.text.toString()
            val word = Word(englishWord = english, translateWord = translate)
            wordDatabase.wordDao().insertWord(word)
            Toast.makeText(context, "Запись скопирована!", Toast.LENGTH_SHORT).show()
        }
        ivF121.setOnClickListener {
            val english : String = tvE121.text.toString()
            val translate : String = tvT121.text.toString()
            val word = Word(englishWord = english, translateWord = translate)
            wordDatabase.wordDao().insertWord(word)
            Toast.makeText(context, "Запись скопирована!", Toast.LENGTH_SHORT).show()
        }
        ivF122.setOnClickListener {
            val english : String = tvE122.text.toString()
            val translate : String = tvT122.text.toString()
            val word = Word(englishWord = english, translateWord = translate)
            wordDatabase.wordDao().insertWord(word)
            Toast.makeText(context, "Запись скопирована!", Toast.LENGTH_SHORT).show()
        }
        ivF123.setOnClickListener {
            val english : String = tvE123.text.toString()
            val translate : String = tvT123.text.toString()
            val word = Word(englishWord = english, translateWord = translate)
            wordDatabase.wordDao().insertWord(word)
            Toast.makeText(context, "Запись скопирована!", Toast.LENGTH_SHORT).show()
        }
        ivF124.setOnClickListener {
            val english : String = tvE124.text.toString()
            val translate : String = tvT124.text.toString()
            val word = Word(englishWord = english, translateWord = translate)
            wordDatabase.wordDao().insertWord(word)
            Toast.makeText(context, "Запись скопирована!", Toast.LENGTH_SHORT).show()
        }
        ivF126.setOnClickListener {
            val english : String = tvE125.text.toString()
            val translate : String = tvT125.text.toString()
            val word = Word(englishWord = english, translateWord = translate)
            wordDatabase.wordDao().insertWord(word)
            Toast.makeText(context, "Запись скопирована!", Toast.LENGTH_SHORT).show()
        }
        ivF127.setOnClickListener {
            val english : String = tvE127.text.toString()
            val translate : String = tvT127.text.toString()
            val word = Word(englishWord = english, translateWord = translate)
            wordDatabase.wordDao().insertWord(word)
            Toast.makeText(context, "Запись скопирована!", Toast.LENGTH_SHORT).show()
        }
        ivF128.setOnClickListener {
            val english : String = tvE128.text.toString()
            val translate : String = tvT128.text.toString()
            val word = Word(englishWord = english, translateWord = translate)
            wordDatabase.wordDao().insertWord(word)
            Toast.makeText(context, "Запись скопирована!", Toast.LENGTH_SHORT).show()
        }
        ivF129.setOnClickListener {
            val english : String = tvE129.text.toString()
            val translate : String = tvT129.text.toString()
            val word = Word(englishWord = english, translateWord = translate)
            wordDatabase.wordDao().insertWord(word)
            Toast.makeText(context, "Запись скопирована!", Toast.LENGTH_SHORT).show()
        }
        ivF130.setOnClickListener {
            val english : String = tvE130.text.toString()
            val translate : String = tvT130.text.toString()
            val word = Word(englishWord = english, translateWord = translate)
            wordDatabase.wordDao().insertWord(word)
            Toast.makeText(context, "Запись скопирована!", Toast.LENGTH_SHORT).show()
        }
        ivF131.setOnClickListener {
            val english : String = tvE131.text.toString()
            val translate : String = tvT131.text.toString()
            val word = Word(englishWord = english, translateWord = translate)
            wordDatabase.wordDao().insertWord(word)
            Toast.makeText(context, "Запись скопирована!", Toast.LENGTH_SHORT).show()
        }
        ivF132.setOnClickListener {
            val english : String = tvE132.text.toString()
            val translate : String = tvT132.text.toString()
            val word = Word(englishWord = english, translateWord = translate)
            wordDatabase.wordDao().insertWord(word)
            Toast.makeText(context, "Запись скопирована!", Toast.LENGTH_SHORT).show()
        }
        ivF133.setOnClickListener {
            val english : String = tvE133.text.toString()
            val translate : String = tvT133.text.toString()
            val word = Word(englishWord = english, translateWord = translate)
            wordDatabase.wordDao().insertWord(word)
            Toast.makeText(context, "Запись скопирована!", Toast.LENGTH_SHORT).show()
        }
        ivF134.setOnClickListener {
            val english : String = tvE134.text.toString()
            val translate : String = tvT134.text.toString()
            val word = Word(englishWord = english, translateWord = translate)
            wordDatabase.wordDao().insertWord(word)
            Toast.makeText(context, "Запись скопирована!", Toast.LENGTH_SHORT).show()
        }
        ivF135.setOnClickListener {
            val english : String = tvE135.text.toString()
            val translate : String = tvT135.text.toString()
            val word = Word(englishWord = english, translateWord = translate)
            wordDatabase.wordDao().insertWord(word)
            Toast.makeText(context, "Запись скопирована!", Toast.LENGTH_SHORT).show()
        }
        ivF136.setOnClickListener {
            val english : String = tvE136.text.toString()
            val translate : String = tvT136.text.toString()
            val word = Word(englishWord = english, translateWord = translate)
            wordDatabase.wordDao().insertWord(word)
            Toast.makeText(context, "Запись скопирована!", Toast.LENGTH_SHORT).show()
        }
    ...
    companion object {
         ...
         * @return A new instance of fragment FrasalVerbsFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            FrasalVerbsFragment().apply {
